...
namespace DreamGuardians
{
    ...
    public sealed class TutorialStage1Director : MonoBehaviour
    {
        ...
        private readonly Dictionary<string, int> hitCountsByPlayer =
        ...
        public TutorialStage1State State { get; private set; } =
        ...
        private IEnumerator BeginRoutine()
        {
            ...
            missionUI?.SetObjective(
                $"{objective} ({requiredHitsPerPlayer}회)");
            ...
            {
                ShowDialogueLine(
                    dialogueData.ShootingInstructionLine);
            }
        ...
        private void PlaceTutorialSpawnInFrontOfCamera()
        {
            PrototypeRayWeapon weapon =
                UnityEngine.Object
                    .FindAnyObjectByType<PrototypeRayWeapon>();
            ...
            {
                desiredPosition.y =
                    groundHit.point.y + 0.05f;
            }
            else
            {
                desiredPosition.y =
                    cameraTransform.position.y - 1.55f;
            }
            ...
            DamageInfo info)
        {
            ...
            if (requireBothSynergiesBeforePurification)
            {
                ...
                {
                    ShowDialogueLine(
                        dialogueData.SynergyInstructionLine);
                }
                else
                {
                    missionUI?.ShowDialogue(
                        "장난감 친구",
                        "잘했어! 이제 두 가지 꿈빛 시너지를 발동해보자!",
                        4f);
                }
        ...
        private void EnablePurificationPhase()
        {
            ...
            State =
                TutorialStage1State.PurifyTutorialEnemy;
            ...
            float _)
        {
            ...
            State =
                TutorialStage1State.TutorialClear;
